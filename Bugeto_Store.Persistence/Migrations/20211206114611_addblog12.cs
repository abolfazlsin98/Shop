        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Orders_OrderState_Enum_Constraint", "[OrderState] IN(0, 1, 2)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogInTags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BlogInTags_BlogPosts_BlogPostId",
                        column: x => x.BlogPostId,
                        principalTable: "BlogPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlogInTags_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_BlogPosts_UserId",
                        column: x => x.UserId,
                        principalTable: "BlogPosts",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogInTags_BlogPostId",
                table: "BlogInTags",
                column: "BlogPostId");

            migrationBuilder.CreateIndex(
                name: "IX_BlogInTags_TagsId",
                table: "BlogInTags",
                column: "TagsId");
